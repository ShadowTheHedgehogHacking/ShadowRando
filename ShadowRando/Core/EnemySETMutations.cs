...
namespace ShadowRando
{
	internal class EnemySETMutations
	{
		...
		public static void ToSpecialWeaponBox(int index, ref List<SetObjectShadow> setData)
		{
			var newEntry = (Object003A_SpecialWeaponBox)LayoutEditorFunctions.CreateShadowObject(0x00, 0x3A, setData[index].PosX, setData[index].PosY,
				setData[index].PosZ, setData[index].RotX, setData[index].RotY, setData[index].RotZ, setData[index].Link, setData[index].Rend, setData[index].UnkBytes);
		...
		public static void ToWeaponBox(int index, ref List<SetObjectShadow> setData)
		{
			var newEntry = (Object000C_WeaponBox)LayoutEditorFunctions.CreateShadowObject(0x00, 0x0C, setData[index].PosX, setData[index].PosY,
				setData[index].PosZ, setData[index].RotX, setData[index].RotY, setData[index].RotZ, setData[index].Link, setData[index].Rend, setData[index].UnkBytes);

			if (setData[index].List == 0x00 && setData[index].Type == 0x3A)
			{
		...
		public static void MutateObjectAtIndex(int index, Type setObjectType, ref List<SetObjectShadow> setData, bool isShadow, Random r)
		{
			...
			{
				ToSpecialWeaponBox(index, ref setData);
			}
			if (setObjectType == typeof(Object000C_WeaponBox))
			{
				ToWeaponBox(index, ref setData);
			}
