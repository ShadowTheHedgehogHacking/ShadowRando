...
{
	internal static class EnemySETMutations
	{
		internal static void ToGUNSoldier(int index, Object0064_GUNSoldier donor, ref List<SetObjectShadow> setData,
			Random r, bool ignoreDonorProperties = false)
		{
			...
			switch (targetEntry)
			{
				...
				{
					var newEntry = (Object0064_GUNSoldier)LayoutEditorFunctions.CreateShadowObject(donor.List,
						donor.Type, originalEnemy.PosX, originalEnemy.PosY,
						originalEnemy.PosZ, originalEnemy.RotX, originalEnemy.RotY, originalEnemy.RotZ,
						originalEnemy.Link, originalEnemy.Rend, originalEnemy.UnkBytes);
					// EnemyBase
				...
				case Object0065_GUNBeetle originalEnemy when targetEntry is Object0065_GUNBeetle:
				{
					...
					newEntry.SearchWidth = originalEnemy.SearchWidth;
					newEntry.SearchHeight = originalEnemy.SearchHeight;
					newEntry.SearchHeightOffset =
						originalEnemy.SearchHeightOffset; // may want to not set this for FlyingEnemy -> GroundEnemy
					newEntry.MoveSpeedRatio = originalEnemy.MoveSpeedRatio;
					// end EnemyBase
					newEntry.AppearType =
						Object0064_GUNSoldier.EAppear
							.RANDOM_MOVE; // there is no good translation for pos0,1,2 for FlyingEnemy -> GroundEnemy; always set to random move type instead
					newEntry.WeaponType = donor.WeaponType;
					newEntry.HaveShield = donor.HaveShield;
					setData[index] = newEntry;
					break;
				...
				case Object0068_GUNRobot originalEnemy when targetEntry is Object0068_GUNRobot:
				{
					...
					switch (originalEnemy.AppearType)
					{
						...
						case Object0068_GUNRobot.EAppear.XXX:
							...
							newEntry.SearchHeightOffset =
								originalEnemy
									.OffsetPos_Y; // GUNSoldiers share their SearchHeightOffset property for Offset mode
				...
				case Object0079_EggPawn originalEnemy when targetEntry is Object0079_EggPawn:
				{
					...
					switch (originalEnemy.AppearType)
					{
						...
						case Object0079_EggPawn.EAppear.DASH:
							...
							newEntry.SearchHeightOffset =
								originalEnemy
									.OffsetPos_Y; // GUNSoldiers share their SearchHeightOffset property for Offset mode (DASH is basically offset mode)
							newEntry.Pos0_TranslationZFromOrigin = originalEnemy.OffsetPos_Z;
							break;
					}
				...
				case Object007A_EggShadowAndroid originalEnemy when targetEntry is Object007A_EggShadowAndroid:
				{
					...
					newEntry.MoveSpeedRatio = originalEnemy.MoveSpeedRatio;
					// end EnemyBase
					newEntry.AppearType = originalEnemy.AppearType == Object007A_EggShadowAndroid.EAppear.OFFSET
						? Object0064_GUNSoldier.EAppear.OFFSETPOS
						: Object0064_GUNSoldier.EAppear.RANDOM_MOVE;
				...
				case Object008D_BkSoldier originalEnemy when targetEntry is Object008D_BkSoldier:
				{
					...
					newEntry.Pos0_WaitType =
						(Object0064_GUNSoldier.EWaitType)originalEnemy.Pos0_WaitType +
						1; // +1 because GUNSoldiers have an extra RADIO state as the first element
					newEntry.Pos0_WaitSec = originalEnemy.Pos0_WaitSec;
					newEntry.Pos0_MoveSpeedRatio = originalEnemy.Pos0_MoveSpeedRatio;
					newEntry.Pos0_TranslationXFromOrigin = originalEnemy.Pos0_TranslationXFromOrigin;
					newEntry.Pos0_TranslationZFromOrigin = originalEnemy.Pos0_TranslationZFromOrigin;

					newEntry.Pos1_WaitType =
						(Object0064_GUNSoldier.EWaitType)originalEnemy.Pos1_WaitType +
						1; // +1 because GUNSoldiers have an extra RADIO state as the first element
					...
					newEntry.Pos2_WaitType =
						(Object0064_GUNSoldier.EWaitType)originalEnemy.Pos2_WaitType +
						1; // +1 because GUNSoldiers have an extra RADIO state as the first element
				...
				{
					var newEntry = (Object0064_GUNSoldier)LayoutEditorFunctions.CreateShadowObject(donor.List,
						donor.Type, targetEntry.PosX, targetEntry.PosY,
						targetEntry.PosZ, targetEntry.RotX, targetEntry.RotY, targetEntry.RotZ, targetEntry.Link,
						targetEntry.Rend, targetEntry.UnkBytes);
					// EnemyBase
		...
		internal static void ToGUNBeetle(int index, Object0065_GUNBeetle donor, ref List<SetObjectShadow> setData,
			Random r, bool ignoreDonorProperties = false)
		{
			var targetEntry = setData[index];
			...
			switch (targetEntry)
			{
				...
				case Object008E_BkWingLarge originalEnemy when targetEntry is Object008E_BkWingLarge:
				{
					...
					if (originalEnemy.ActionType == Object008E_BkWingLarge.EAction.AIR_CUTTER)
						actionType = r.Next(2) == 1
							? Object0065_GUNBeetle.EAction.USE_WEAPON
							: Object0065_GUNBeetle.EAction.SHOCK;

					var newEntry = (Object0065_GUNBeetle)LayoutEditorFunctions.CreateShadowObject(donor.List,
						donor.Type, targetEntry.PosX, targetEntry.PosY,
						targetEntry.PosZ, targetEntry.RotX, targetEntry.RotY, targetEntry.RotZ, targetEntry.Link,
						targetEntry.Rend, targetEntry.UnkBytes);
					newEntry.MoveRange = originalEnemy.MoveRange;
		...
		internal static void ToGUNBigfoot(int index, Object0066_GUNBigfoot donor, ref List<SetObjectShadow> setData,
			Random r, bool ignoreDonorProperties = false)
		{
			var targetEntry = setData[index];
			...
			switch (targetEntry)
			{
				case Object0064_GUNSoldier originalEnemy when targetEntry is Object0064_GUNSoldier:
				default:
					var newEntry = (Object0066_GUNBigfoot)LayoutEditorFunctions.CreateShadowObject(donor.List,
						donor.Type, targetEntry.PosX, targetEntry.PosY,
						targetEntry.PosZ, targetEntry.RotX, targetEntry.RotY, targetEntry.RotZ, targetEntry.Link,
						targetEntry.Rend, targetEntry.UnkBytes);
					// EnemyBase
		...
		internal static void ToGUNRobot(int index, Object0068_GUNRobot donor, ref List<SetObjectShadow> setData,
			Random r, bool ignoreDonorProperties = false)
		{
			var targetEntry = setData[index];
			...
			switch (targetEntry)
			{
				case Object0064_GUNSoldier originalEnemy when targetEntry is Object0064_GUNSoldier:
				default:
					var newEntry = (Object0068_GUNRobot)LayoutEditorFunctions.CreateShadowObject(donor.List, donor.Type,
						targetEntry.PosX, targetEntry.PosY,
						targetEntry.PosZ, targetEntry.RotX, targetEntry.RotY, targetEntry.RotZ, targetEntry.Link,
						targetEntry.Rend, targetEntry.UnkBytes);
					// EnemyBase
					newEntry.MoveRange = donor.MoveRange;
		...
		internal static void ToEggPierrot(int index, Object0078_EggPierrot donor, ref List<SetObjectShadow> setData,
			Random r, bool ignoreDonorProperties = false)
		{
			var targetEntry = setData[index];
			...
			switch (targetEntry)
			{
				case Object0064_GUNSoldier originalEnemy when targetEntry is Object0064_GUNSoldier:
				default:
					var newEntry = (Object0078_EggPierrot)LayoutEditorFunctions.CreateShadowObject(donor.List,
						donor.Type, targetEntry.PosX, targetEntry.PosY,
						targetEntry.PosZ, targetEntry.RotX, targetEntry.RotY, targetEntry.RotZ, targetEntry.Link,
						targetEntry.Rend, targetEntry.UnkBytes);
					// EnemyBase
		...
		internal static void ToEggPawn(int index, Object0079_EggPawn donor, ref List<SetObjectShadow> setData, Random r,
			bool ignoreDonorProperties = false)
		{
			var targetEntry = setData[index];
			...
			switch (targetEntry)
			{
				case Object0064_GUNSoldier originalEnemy when targetEntry is Object0064_GUNSoldier:
				default:
					var newEntry = (Object0079_EggPawn)LayoutEditorFunctions.CreateShadowObject(donor.List, donor.Type,
						targetEntry.PosX, targetEntry.PosY,
						targetEntry.PosZ, targetEntry.RotX, targetEntry.RotY, targetEntry.RotZ, targetEntry.Link,
						targetEntry.Rend, targetEntry.UnkBytes);
					// EnemyBase
		...
		internal static void ToEggShadowAndroid(int index, Object007A_EggShadowAndroid donor,
			ref List<SetObjectShadow> setData, Random r, bool ignoreDonorProperties = false)
		{
			var targetEntry = setData[index];
			...
			switch (targetEntry)
			{
				case Object0064_GUNSoldier originalEnemy when targetEntry is Object0064_GUNSoldier:
				default:
					var newEntry = (Object007A_EggShadowAndroid)LayoutEditorFunctions.CreateShadowObject(donor.List,
						donor.Type, targetEntry.PosX, targetEntry.PosY,
						targetEntry.PosZ, targetEntry.RotX, targetEntry.RotY, targetEntry.RotZ, targetEntry.Link,
						targetEntry.Rend, targetEntry.UnkBytes);
					// EnemyBase
		...
		internal static void ToBkGiant(int index, Object008C_BkGiant donor, ref List<SetObjectShadow> setData, Random r,
			bool ignoreDonorProperties = false)
		{
			var targetEntry = setData[index];
			...
			switch (targetEntry)
			{
				case Object0064_GUNSoldier originalEnemy when targetEntry is Object0064_GUNSoldier:
				default:
					var newEntry = (Object008C_BkGiant)LayoutEditorFunctions.CreateShadowObject(donor.List, donor.Type,
						targetEntry.PosX, targetEntry.PosY,
						targetEntry.PosZ, targetEntry.RotX, targetEntry.RotY, targetEntry.RotZ, targetEntry.Link,
						targetEntry.Rend, targetEntry.UnkBytes);
					// EnemyBase
		...
		internal static void ToBkSoldier(int index, Object008D_BkSoldier donor, ref List<SetObjectShadow> setData,
			Random r, bool ignoreDonorProperties = false)
		{
			var targetEntry = setData[index];
			...
			switch (targetEntry)
			{
				case Object0064_GUNSoldier originalEnemy when targetEntry is Object0064_GUNSoldier:
				default:
					var newEntry = (Object008D_BkSoldier)LayoutEditorFunctions.CreateShadowObject(donor.List,
						donor.Type, targetEntry.PosX, targetEntry.PosY,
						targetEntry.PosZ, targetEntry.RotX, targetEntry.RotY, targetEntry.RotZ, targetEntry.Link,
						targetEntry.Rend, targetEntry.UnkBytes);
					// EnemyBase
		...
		internal static void ToBkWingLarge(int index, Object008E_BkWingLarge donor, ref List<SetObjectShadow> setData,
			Random r, bool ignoreDonorProperties = false)
		{
			var targetEntry = setData[index];
			...
			switch (targetEntry)
			{
				case Object0065_GUNBeetle originalEnemy when targetEntry is Object0065_GUNBeetle:
				{
					...
					var newEntry = (Object008E_BkWingLarge)LayoutEditorFunctions.CreateShadowObject(donor.List,
						donor.Type, targetEntry.PosX, targetEntry.PosY,
						targetEntry.PosZ, targetEntry.RotX, targetEntry.RotY, targetEntry.RotZ, targetEntry.Link,
						targetEntry.Rend, targetEntry.UnkBytes);
					newEntry.MoveRange = originalEnemy.MoveRange;
					...
					newEntry.ActionType =
						(originalEnemy.ActionType == Object0065_GUNBeetle.EAction.SHOCK ||
						 originalEnemy.ActionType == Object0065_GUNBeetle.EAction.USE_WEAPON)
							? Object008E_BkWingLarge.EAction.AIR_CUTTER
							: Object008E_BkWingLarge.EAction.NONE;
		...
		internal static void ToBkWingSmall(int index, Object008F_BkWingSmall donor, ref List<SetObjectShadow> setData,
			Random r, bool ignoreDonorProperties = false)
		{
			var targetEntry = setData[index];
			...
			switch (targetEntry)
			{
				case Object0065_GUNBeetle originalEnemy when targetEntry is Object0065_GUNBeetle:
				{
					var newEntry = (Object008F_BkWingSmall)LayoutEditorFunctions.CreateShadowObject(donor.List,
						donor.Type, targetEntry.PosX, targetEntry.PosY,
						targetEntry.PosZ, targetEntry.RotX, targetEntry.RotY, targetEntry.RotZ, targetEntry.Link,
						targetEntry.Rend, targetEntry.UnkBytes);
					newEntry.MoveRange = originalEnemy.MoveRange;
					...
					newEntry.ActionType =
						(originalEnemy.ActionType == Object0065_GUNBeetle.EAction.SHOCK ||
						 originalEnemy.ActionType == Object0065_GUNBeetle.EAction.USE_WEAPON)
							? Object008F_BkWingSmall.EAction.ATTACK
							: Object008F_BkWingSmall.EAction.NONE;
		...
		internal static void ToBkWorm(int index, Object0090_BkWorm donor, ref List<SetObjectShadow> setData, Random r,
			bool ignoreDonorProperties = false)
		{
			var targetEntry = setData[index];
			...
			switch (targetEntry)
			{
				case Object0064_GUNSoldier originalEnemy when targetEntry is Object0064_GUNSoldier:
				default:
					var newEntry = (Object0090_BkWorm)LayoutEditorFunctions.CreateShadowObject(donor.List, donor.Type,
						targetEntry.PosX, targetEntry.PosY,
						targetEntry.PosZ, targetEntry.RotX, targetEntry.RotY, targetEntry.RotZ, targetEntry.Link,
						targetEntry.Rend, targetEntry.UnkBytes);
					// EnemyBase
		...
		internal static void ToBkLarva(int index, Object0091_BkLarva donor, ref List<SetObjectShadow> setData, Random r,
			bool ignoreDonorProperties = false)
		{
			var targetEntry = setData[index];
			...
			switch (targetEntry)
			{
				case Object0064_GUNSoldier originalEnemy when targetEntry is Object0064_GUNSoldier:
				default:
					var newEntry = (Object0091_BkLarva)LayoutEditorFunctions.CreateShadowObject(donor.List, donor.Type,
						targetEntry.PosX, targetEntry.PosY,
						targetEntry.PosZ, targetEntry.RotX, targetEntry.RotY, targetEntry.RotZ, targetEntry.Link,
						targetEntry.Rend, targetEntry.UnkBytes);
					// EnemyBase
		...
		internal static void ToBkChaos(int index, Object0092_BkChaos donor, ref List<SetObjectShadow> setData, Random r,
			bool ignoreDonorProperties = false)
		{
			var targetEntry = setData[index];
			...
			switch (targetEntry)
			{
				case Object0064_GUNSoldier originalEnemy when targetEntry is Object0064_GUNSoldier:
				default:
					var newEntry = (Object0092_BkChaos)LayoutEditorFunctions.CreateShadowObject(donor.List, donor.Type,
						targetEntry.PosX, targetEntry.PosY,
						targetEntry.PosZ, targetEntry.RotX, targetEntry.RotY, targetEntry.RotZ, targetEntry.Link,
						targetEntry.Rend, targetEntry.UnkBytes);
					// EnemyBase
		...
		internal static void ToBkNinja(int index, Object0093_BkNinja donor, ref List<SetObjectShadow> setData, Random r,
			bool ignoreDonorProperties = false)
		{
			var targetEntry = setData[index];
			...
			switch (targetEntry)
			{
				case Object0064_GUNSoldier originalEnemy when targetEntry is Object0064_GUNSoldier:
				default:
					var newEntry = (Object0093_BkNinja)LayoutEditorFunctions.CreateShadowObject(donor.List, donor.Type,
						targetEntry.PosX, targetEntry.PosY,
						targetEntry.PosZ, targetEntry.RotX, targetEntry.RotY, targetEntry.RotZ, targetEntry.Link,
						targetEntry.Rend, targetEntry.UnkBytes);
					// EnemyBase
		...
		internal static void ToGUNSoldier(int index, ref List<SetObjectShadow> setData, Random r)
		{
		...
		internal static void ToGUNBeetle(int index, ref List<SetObjectShadow> setData, Random r)
		{
			...
			var donor = new Object0065_GUNBeetle
			{
				...
				WeaponType = weapon,
				ActionType = weapon == Object0065_GUNBeetle.EWeapon.NONE
					? Object0065_GUNBeetle.EAction.SHOCK
					: Object0065_GUNBeetle.EAction.USE_WEAPON,
		...
		internal static void ToGUNBigfoot(int index, ref List<SetObjectShadow> setData, Random r)
		{
		...
		internal static void ToGUNRobot(int index, ref List<SetObjectShadow> setData, Random r)
		{
		...
		internal static void ToEggPierrot(int index, ref List<SetObjectShadow> setData, Random r)
		{
		...
		internal static void ToEggPawn(int index, ref List<SetObjectShadow> setData, Random r)
		{
		...
		internal static void ToEggShadowAndroid(int index, ref List<SetObjectShadow> setData, Random r)
		{
		...
		internal static void ToBkGiant(int index, ref List<SetObjectShadow> setData, Random r)
		{
		...
		internal static void ToBkSoldier(int index, ref List<SetObjectShadow> setData, Random r)
		{
			var donor = new Object008D_BkSoldier
			{
				...
				Pos2_WaitSec = 1,
				Pos2_MoveSpeedRatio = 1,
				IsOnAirSaucer = r.Next(10) == 1
					? (Object008D_BkSoldier.EBkSoldierNoYes)1
					: (Object008D_BkSoldier.EBkSoldierNoYes)0, // 10% chance of saucer
			};
			ToBkSoldier(index, donor, ref setData, r, true);
		}

		internal static void ToBkWingLarge(int index, ref List<SetObjectShadow> setData, Random r)
		{
			// account for BlackVolt non standard enum
			var bodyType = r.Next(4);
		...
		internal static void ToBkWingSmall(int index, ref List<SetObjectShadow> setData, Random r)
		{
		...
		internal static void ToBkWorm(int index, ref List<SetObjectShadow> setData, Random r)
		{
		...
		internal static void ToBkLarva(int index, ref List<SetObjectShadow> setData, Random r)
		{
		...
		internal static void ToBkNinja(int index, ref List<SetObjectShadow> setData, Random r)
		{
